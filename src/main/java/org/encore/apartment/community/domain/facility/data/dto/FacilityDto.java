...
public class FacilityDto {
	...
	public static Facility toEntity(FacilityDto facilityDto) {
		return Facility.builder()
			...
			.facilityReservationAvailableTime(facilityDto.getFacilityReservationAvailbleTime())
			.build();
	}
	...
	public FacilityDto(Facility facility) {
		...
		this.facilityReservationAvailbleTime = facility.getFacilityReservationAvailableTime();
	}
}
